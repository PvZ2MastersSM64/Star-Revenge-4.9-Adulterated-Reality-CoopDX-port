...
//KoopaBoB Has a level embedded value, Default fallback used.
...
const Trajectory rr_seg7_trajectory_0702EC3C_RM2C_path[] = {
	TRAJECTORY_POS(0, /*pos*/ 5215, 4129, -7128),
	TRAJECTORY_POS(1, /*pos*/ 5861, 4339, -6106),
	TRAJECTORY_POS(2, /*pos*/ 6398, 3079, -4528),
	TRAJECTORY_POS(3, /*pos*/ 7922, 3349, -4175),
	TRAJECTORY_POS(4, /*pos*/ 8456, 4609, -6837),
	TRAJECTORY_POS(5, /*pos*/ 9594, 3979, -5759),
	TRAJECTORY_END(),
};
...
const Trajectory bob_seg7_metal_ball_path0_RM2C_path[] = {
	// This trajectory was either read wrong or corrupted! No postional output was written as a result.
	TRAJECTORY_END(),
};
