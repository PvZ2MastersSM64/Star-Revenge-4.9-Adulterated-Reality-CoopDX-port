...
ALIGNED8 u8 wiggler_body_geo__texture_05005A30[] = {
#include "actors/wiggler_body/wiggler_body_geo_0x5005a30_custom.rgba16.inc.c"
};
ALIGNED8 u8 wiggler_body_geo__texture_05006A30[] = {
#include "actors/wiggler_body/wiggler_body_geo_0x5006a30_custom.rgba16.inc.c"
};

Vtx VB_wiggler_body_geo_0x500b278[] = {
...
Vtx VB_wiggler_body_geo_0x500b378[] = {
	{{{ 0, -59, 21 }, 0, { 0, 0 }, { 183, 161, 39, 255}}},
...
Vtx VB_wiggler_body_geo_0x500b478[] = {
	{{{ 20, -37, 43 }, 0, { 0, 0 }, { 72, 235, 102, 255}}},
	{{{ -5, -36, 43 }, 0, { 0, 0 }, { 189, 228, 103, 0}}},
...
Vtx VB_wiggler_body_geo_0x500b578[] = {
	{{{ 20, -66, -21 }, 0, { 0, 0 }, { 127, 2, 0, 255}}},
...
Vtx VB_wiggler_body_geo_0x500b5b8[] = {
...
Vtx VB_wiggler_body_geo_0x500b6a8[] = {
...
Vtx VB_wiggler_body_geo_0x500b798[] = {
...
Vtx VB_wiggler_body_geo_0x500b898[] = {
	{{{ -17, -33, -21 }, 0, { 0, 0 }, { 137, 227, 225, 255}}},
	{{{ -5, -36, -43 }, 0, { 0, 0 }, { 189, 228, 153, 0}}},
...
Vtx VB_wiggler_body_geo_0x500b998[] = {
	{{{ 20, -66, -21 }, 0, { 0, 0 }, { 66, 161, 206, 255}}},
	{{{ 0, -59, -21 }, 0, { 0, 0 }, { 183, 161, 217, 0}}},
	{{{ -5, -36, -43 }, 0, { 0, 0 }, { 189, 228, 153, 0}}},
	{{{ 20, -37, -43 }, 0, { 0, 0 }, { 72, 235, 154, 255}}},
...
Vtx VB_wiggler_body_geo_0x500ba98[] = {
	{{{ 20, -66, -21 }, 0, { 0, 0 }, { 127, 2, 0, 255}}},
	{{{ 19, 5, 31 }, 0, { 0, 0 }, { 57, 43, 104, 0}}},
	{{{ 20, -37, 43 }, 0, { 0, 0 }, { 27, 231, 121, 0}}},
	{{{ 20, -66, 21 }, 0, { 0, 0 }, { 127, 2, 0, 255}}},
...
Vtx VB_wiggler_body_geo_0x500bad8[] = {
...
Vtx VB_wiggler_body_geo_0x500bbc8[] = {
...
Vtx VB_wiggler_body_geo_0x500c188[] = {
...
Vtx VB_wiggler_body_geo_0x500c1c8[] = {
...
Gfx DL_wiggler_body_geo_0x500c278[] = {
	gsDPPipeSync(),
	...
	gsSPDisplayList(DL_wiggler_body_geo_0x500c208),
	gsSPDisplayList(DL_wiggler_body_geo_0x500c240),
...
Gfx DL_wiggler_body_geo_0x500c208[] = {
	gsDPSetTextureImage(0, 2, 1, wiggler_body_geo__texture_05005A30),
	gsDPLoadSync(),
	gsDPLoadBlock(7, 0, 0, 2047, 256),
	gsSPVertex(VB_wiggler_body_geo_0x500c188, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
	gsSPEndDisplayList(),
};

Gfx DL_wiggler_body_geo_0x500c240[] = {
	gsDPSetTextureImage(0, 2, 1, wiggler_body_geo__texture_05006A30),
	gsDPLoadSync(),
	gsDPLoadBlock(7, 0, 0, 2047, 256),
	gsSPVertex(VB_wiggler_body_geo_0x500c1c8, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPEndDisplayList(),
};

Light_t Light_wiggler_body_geo_0x500b250 = {
	{ 231, 71, 0}, 0, { 231, 71, 0}, 0, { 40, 40, 40}, 0
};

Ambient_t Light_wiggler_body_geo_0x500b248 = {
	{57, 17, 0}, 0, {57, 17, 0}, 0
};

Gfx DL_wiggler_body_geo_0x500be98[] = {
	gsSPLight(&Light_wiggler_body_geo_0x500b250.col, 1),
	gsSPLight(&Light_wiggler_body_geo_0x500b248.col, 2),
	gsSPVertex(VB_wiggler_body_geo_0x500b6a8, 15, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Gfx DL_wiggler_body_geo_0x500be10[] = {
	gsSPLight(&Light_wiggler_body_geo_0x500b250.col, 1),
	gsSPLight(&Light_wiggler_body_geo_0x500b248.col, 2),
	gsSPVertex(VB_wiggler_body_geo_0x500b5b8, 15, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
	gsSP2Triangles(8, 0, 3, 0, 8, 3, 9, 0),
	gsSP2Triangles(1, 4, 7, 0, 1, 7, 2, 0),
...
Light_t Light_wiggler_body_geo_0x500b238 = {
	{ 223, 0, 0}, 0, { 223, 0, 0}, 0, { 40, 40, 40}, 0
};

Ambient_t Light_wiggler_body_geo_0x500b230 = {
	{55, 0, 0}, 0, {55, 0, 0}, 0
};

Gfx DL_wiggler_body_geo_0x500bcb8[] = {
	gsSPLight(&Light_wiggler_body_geo_0x500b238.col, 1),
	gsSPLight(&Light_wiggler_body_geo_0x500b230.col, 2),
	gsSPVertex(VB_wiggler_body_geo_0x500b278, 16, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
	gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
	gsSP2Triangles(12, 13, 14, 0, 12, 14, 15, 0),
	gsSPVertex(VB_wiggler_body_geo_0x500b378, 16, 0),
	...
	gsSPVertex(VB_wiggler_body_geo_0x500b478, 16, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 1, 0, 4, 1, 6, 0),
	gsSP2Triangles(7, 6, 8, 0, 7, 9, 6, 0),
	gsSP2Triangles(10, 11, 12, 0, 10, 12, 13, 0),
	gsSP2Triangles(10, 13, 14, 0, 10, 14, 15, 0),
	gsSPVertex(VB_wiggler_body_geo_0x500b578, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPEndDisplayList(),
};

Gfx DL_wiggler_body_geo_0x500c100[] = {
	gsSPLight(&Light_wiggler_body_geo_0x500b250.col, 1),
	gsSPLight(&Light_wiggler_body_geo_0x500b248.col, 2),
	gsSPVertex(VB_wiggler_body_geo_0x500bbc8, 15, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
	gsSP2Triangles(8, 0, 3, 0, 8, 3, 9, 0),
	gsSP2Triangles(1, 4, 7, 0, 1, 7, 2, 0),
...
Gfx DL_wiggler_body_geo_0x500c078[] = {
	gsSPLight(&Light_wiggler_body_geo_0x500b250.col, 1),
	gsSPLight(&Light_wiggler_body_geo_0x500b248.col, 2),
	gsSPVertex(VB_wiggler_body_geo_0x500bad8, 15, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
	gsSP2Triangles(8, 0, 3, 0, 8, 3, 9, 0),
	gsSP2Triangles(1, 4, 7, 0, 1, 7, 2, 0),
...
Gfx DL_wiggler_body_geo_0x500bf20[] = {
	gsSPLight(&Light_wiggler_body_geo_0x500b238.col, 1),
	gsSPLight(&Light_wiggler_body_geo_0x500b230.col, 2),
	gsSPVertex(VB_wiggler_body_geo_0x500b798, 16, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
	gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
	gsSP2Triangles(12, 13, 14, 0, 12, 14, 15, 0),
	gsSPVertex(VB_wiggler_body_geo_0x500b898, 16, 0),
	gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
	...
	gsSPVertex(VB_wiggler_body_geo_0x500b998, 16, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 2, 5, 0, 4, 5, 6, 0),
	gsSP2Triangles(7, 8, 9, 0, 7, 4, 8, 0),
	gsSP2Triangles(10, 11, 12, 0, 10, 12, 13, 0),
	gsSP2Triangles(10, 13, 14, 0, 10, 14, 15, 0),
	gsSPVertex(VB_wiggler_body_geo_0x500ba98, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPEndDisplayList(),
};
