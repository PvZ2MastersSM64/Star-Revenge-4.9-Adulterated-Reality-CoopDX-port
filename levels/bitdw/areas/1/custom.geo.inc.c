...
const GeoLayout Geo_bitdw_1_0x2d66eb0[]= {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_NODE_ORTHO(100),
			GEO_OPEN_NODE(),
				GEO_BACKGROUND(SkyboxCustom47452048_skybox_ptrlist, geo_skybox_main),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(1, DL_bitdw_1_0xe0abb10),
					GEO_DISPLAY_LIST(5, DL_bitdw_1_0xe0c4618),
					GEO_DISPLAY_LIST(4, DL_bitdw_1_0xe0c9dc0),
					GEO_RENDER_OBJ(),
