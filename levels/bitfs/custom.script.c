...
const LevelScript local_objects_bitfs_1_[] = {
	...
	OBJECT_WITH_ACTS(0, -10, 5, 5, 0, 0, 20, 338,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -3, 5, 63, 0, 0, 20, 339,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
