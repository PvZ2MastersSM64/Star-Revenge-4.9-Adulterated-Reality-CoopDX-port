...
const GeoLayout Geo_bits_2_0x2eaf780[]= {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(1, DL_bits_2_0xe09c7f0),
					GEO_DISPLAY_LIST(5, DL_bits_2_0xe0bba00),
					GEO_DISPLAY_LIST(4, DL_bits_2_0xe0bd150),
					GEO_RENDER_OBJ(),
