...
const LevelScript local_area_bits_2_[] = {
	AREA(2, Geo_bits_2_0x2eaf780),
	TERRAIN(col_bits_2_0xe0bd750),
...
const LevelScript local_objects_bits_2_[] = {
	...
	OBJECT_WITH_ACTS(0, -5604, 2493, 6154, 0, 0, 0, 0x10000,  bhvAirborneStarCollectWarp, 31),
	OBJECT_WITH_ACTS(0, -5604, 2493, 6154, 0, 0, 0, 0xa0000,  bhvSpinAirborneWarp, 31),
	...
	OBJECT_WITH_ACTS(0, -12958, 5100, 13460, 0, 180, 0, 0x0,  bhvOpenableGrill, 31),
	...
	OBJECT_WITH_ACTS(0, 30, 4, 128, 0, 0, 20, 340,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 30, 4, 98, 0, 0, 20, 341,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -10, 5, 45, 0, 0, 20, 342,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 30, 4, 138, 0, 0, 20, 343,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 60, 4, 147, 0, 0, 20, 344,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -10, 5, 43, 0, 0, 20, 345,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
