...
const LevelScript level_bob_entry[] = {
	...
	LOAD_MIO0(0xA, _SkyboxCustom20484528_skybox_mio0SegmentRomStart, _SkyboxCustom20484528_skybox_mio0SegmentRomEnd),
...
const LevelScript local_objects_bob_1_[] = {
	...
	OBJECT_WITH_ACTS(0, -5, 5, 777, 0, 0, 20, 141,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -5, 5, 75, 0, 0, 20, 142,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -7, 5, 8, 0, 0, 20, 143,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
