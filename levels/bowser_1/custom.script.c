...
const LevelScript local_objects_bowser_1_1_[] = {
	...
	OBJECT_WITH_ACTS(0, -22, 5, 73, 0, 0, 20, 346,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -22, 5, 319, 0, 0, 20, 347,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 18, 4, 1168, 0, 0, 20, 348,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
