...
const LevelScript local_objects_bowser_3_1_[] = {
	...
	OBJECT_WITH_ACTS(46, -10051, 3900, 2456, 0, 0, 0, 0x0,  bhvCheckpoint_Flag_MOP, 31),
	OBJECT_WITH_ACTS(46, -10189, 3825, -8847, 0, 0, 0, 0x0,  bhvCheckpoint_Flag_MOP, 31),
	...
	OBJECT_WITH_ACTS(0, 12, 4, 24, 0, 0, 20, 349,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 12, 4, 4, 0, 0, 20, 350,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 12, 4, 4, 0, 0, 20, 351,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 12, 4, 4, 0, 0, 20, 352,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 12, 4, 4, 0, 0, 20, 353,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 12, 4, 4, 0, 0, 20, 354,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 12, 4, 4, 0, 0, 20, 355,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 12, 4, 4, 0, 0, 20, 356,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 12, 4, 22, 0, 0, 20, 357,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 12, 4, 22, 0, 0, 20, 358,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -20, 5, 32, 0, 0, 20, 359,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -20, 5, 40, 0, 0, 20, 360,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 12, 4, 94, 0, 0, 20, 361,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 12, 4, 12, 0, 0, 20, 362,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
