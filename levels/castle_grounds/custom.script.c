...
const LevelScript level_castle_grounds_entry[] = {
	...
	LOAD_MIO0(0xA, _SkyboxCustom40608416_skybox_mio0SegmentRomStart, _SkyboxCustom40608416_skybox_mio0SegmentRomEnd),
	...
	FREE_LEVEL_POOL(),
	MARIO_POS(/* area */ 1, /* yaw */ 0, /* pos */ 1702, 1417, 1833),
...
const LevelScript local_area_castle_grounds_1_[] = {
	AREA(1, Geo_castle_grounds_1_0x26e01c0),
	TERRAIN(col_castle_grounds_1_0xe0dcc20),
...
const LevelScript local_objects_castle_grounds_1_[] = {
	...
	OBJECT_WITH_ACTS(15, 2081, 900, 2030, 0, 0, 0, 0x3f0000,  bhvBobombBuddy, 31),
	...
	OBJECT_WITH_ACTS(221, -2849, 3000, -1261, 0, 0, 0, 0x53000000,  bhvToadMessage, 31),
	...
	OBJECT_WITH_ACTS(137, 8865, 1516, -2352, 0, 8, 0, 0x10000,  bhvExclamationBox, 31),
	...
	OBJECT_WITH_ACTS(116, -2942, 3139, -3109, 0, 0, 0, 0x0,  bhvOneCoin, 31),
	OBJECT_WITH_ACTS(212, 7888, 2406, 8007, 0, 0, 0, 0x0,  bhv1Up, 31),
	OBJECT_WITH_ACTS(212, -8, 2486, -5403, 0, 0, 0, 0x0,  bhv1Up, 31),
	OBJECT_WITH_ACTS(0, -8, 5, 108, 0, 0, 20, 0,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -8, 5, 18, 0, 0, 20, 1,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -15, 5, 24, 0, 0, 20, 2,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -15, 5, 24, 0, 0, 20, 3,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -15, 5, 24, 0, 0, 20, 4,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -12, 5, 30, 0, 0, 20, 5,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 20, 5, 90, 0, 0, 20, 6,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 16, 4, 24, 0, 0, 20, 7,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -16, 5, 12, 0, 0, 20, 8,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 16, 4, 18, 0, 0, 20, 9,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -8, 5, 48, 0, 0, 20, 10,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
...
const LevelScript local_area_castle_grounds_2_[] = {
	AREA(2, Geo_castle_grounds_2_0x26e00a0),
...
const LevelScript local_objects_castle_grounds_2_[] = {
	...
	OBJECT_WITH_ACTS(31, 1574, 0, -1, 0, 90, 0, 0x6e000000,  bhvDoor, 31),
	OBJECT_WITH_ACTS(31, -1574, 0, 3, 0, 270, 0, 0x50000000,  bhvDoor, 31),
	OBJECT_WITH_ACTS(0, 5400, 1260, 2, 0, 0, 0, 0x20000,  bhvWarp, 31),
	OBJECT_WITH_ACTS(0, -5393, 1260, -7, 0, 0, 0, 0x30000,  bhvWarp, 31),
	OBJECT_WITH_ACTS(0, -6, 1330, 5394, 0, 0, 0, 0x10000,  bhvWarp, 31),
	...
	OBJECT_WITH_ACTS(124, -1, 0, -804, 0, 180, 0, 0x3a0000,  bhvMessagePanel, 31),
	OBJECT_WITH_ACTS(46, 5, -677, -5995, 0, 0, 0, 0x10000,  bhvCheckpoint_Flag_MOP, 31),
	OBJECT_WITH_ACTS(212, -1, 240, -812, 0, 0, 0, 0x0,  bhv1Up, 31),
	OBJECT_WITH_ACTS(0, -15, 5, 597, 0, 0, 20, 11,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -25, 5, 68, 0, 0, 20, 12,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -25, 5, 23, 0, 0, 20, 13,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -25, 5, 36, 0, 0, 20, 14,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -15, 5, 5, 0, 0, 20, 15,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -25, 5, 5, 0, 0, 20, 16,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -15, 5, 5, 0, 0, 20, 17,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
...
const LevelScript local_area_castle_grounds_3_[] = {
	AREA(3, Geo_castle_grounds_3_0x26dff80),
	TERRAIN(col_castle_grounds_3_0xe027320),
...
const LevelScript local_objects_castle_grounds_3_[] = {
	...
	OBJECT_WITH_ACTS(15, -3997, 2524, 22237, 0, 0, 0, 0xa30000,  bhvBobombBuddy, 31),
	OBJECT_WITH_ACTS(195, 1618, 7498, 933, 0, 0, 0, 0x790000,  bhvBobombBuddy, 31),
	OBJECT_WITH_ACTS(0, 14, 5, 99, 0, 0, 20, 18,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 14, 5, 48, 0, 0, 20, 19,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 14, 5, 2118, 0, 0, 20, 20,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 14, 5, 1965, 0, 0, 20, 21,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 14, 5, 765, 0, 0, 20, 22,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 14, 5, 2142, 0, 0, 20, 23,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
