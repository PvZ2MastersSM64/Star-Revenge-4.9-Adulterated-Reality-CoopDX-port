...
const LevelScript level_ccm_entry[] = {
	...
	LOAD_MIO0(0xA, _SkyboxCustom24323680_skybox_mio0SegmentRomStart, _SkyboxCustom24323680_skybox_mio0SegmentRomEnd),
...
const LevelScript local_objects_ccm_1_[] = {
	...
	OBJECT_WITH_ACTS(0, 17061, 3450, 46, 0, 0, 0, 0xf070000,  bhvWarp, 31),
	OBJECT_WITH_ACTS(0, 17061, 3450, 46, 0, 0, 0, 0xf070000,  bhvWarp, 31),
	OBJECT_WITH_ACTS(212, 6449, 1260, -2777, 0, 0, 0, 0x0,  bhv1Up, 31),
	OBJECT_WITH_ACTS(123, 2150, 2850, 9832, 0, 0, 0, 0x3c0000,  bhvNoteblock_MOP, 31),
	OBJECT_WITH_ACTS(0, -4, 5, 93, 0, 0, 20, 152,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 30, 4, 101, 0, 0, 20, 153,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
