...
const LevelScript local_objects_ddd_1_[] = {
	...
	OBJECT_WITH_ACTS(212, 4396, 3290, -5516, 0, 90, 0, 0x330000,  bhv1Up, 31),
	...
	OBJECT_WITH_ACTS(0, -4, 5, 14, 0, 0, 20, 174,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -4, 5, 117, 0, 0, 20, 175,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -4, 5, 33, 0, 0, 20, 176,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -2, 5, 35, 0, 0, 20, 177,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -4, 5, 197, 0, 0, 20, 178,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -10, 5, 29, 0, 0, 20, 179,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -10, 5, 13, 0, 0, 20, 180,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 4, 4, 105, 0, 0, 20, 181,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
...
const LevelScript local_objects_ddd_2_[] = {
	...
	OBJECT_WITH_ACTS(0, 2, 4, 14, 0, 0, 20, 182,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
