...
const LevelScript local_objects_ending_3_[] = {
	...
	OBJECT_WITH_ACTS(129, 100, -319, -325, 0, 0, 0, 0x0,  bhvHiddenObject, 31),
	OBJECT_WITH_ACTS(129, -100, -319, -325, 0, 0, 0, 0x0,  bhvHiddenObject, 31),
	OBJECT_WITH_ACTS(0, -12, 5, 104, 0, 0, 20, 398,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -12, 5, 78, 0, 0, 20, 399,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 4, 5, 29, 0, 0, 20, 400,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 4, 5, 29, 0, 0, 20, 401,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 4, 5, 29, 0, 0, 20, 402,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 4, 5, 4, 0, 0, 20, 403,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 4, 5, 29, 0, 0, 20, 404,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
...
const LevelScript local_objects_ending_4_[] = {
	...
	OBJECT_WITH_ACTS(0, 4, 4, 253, 0, 0, 20, 405,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -12, 5, 78, 0, 0, 20, 406,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
...
const LevelScript local_objects_ending_7_[] = {
	...
	OBJECT_WITH_ACTS(0, -7, 4, 52, 0, 0, 20, 407,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
