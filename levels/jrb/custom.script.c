...
const LevelScript level_jrb_entry[] = {
	...
	LOAD_MIO0(0xA, _SkyboxCustom23173008_skybox_mio0SegmentRomStart, _SkyboxCustom23173008_skybox_mio0SegmentRomEnd),
...
const LevelScript local_objects_jrb_1_[] = {
	...
	OBJECT_WITH_ACTS(137, 16726, 59, 1442, 0, 0, 0, 0xe0000,  bhvExclamationBox, 31),
	...
	OBJECT_WITH_ACTS(124, 14640, 3900, 9191, 0, 90, 0, 0x10000,  bhvMessagePanel, 31),
	...
	OBJECT_WITH_ACTS(0, 3101, 3060, 54, 0, 23, 0, 0x40000,  bhvGoombaTripletSpawner, 31),
	OBJECT_WITH_ACTS(116, 7332, -840, 256, 0, 0, 0, 0x0,  bhvOneCoin, 31),
	OBJECT_WITH_ACTS(0, 6503, -1090, -605, 0, 0, 0, 0x110000,  bhvCoinFormation, 31),
	...
	OBJECT_WITH_ACTS(212, -12452, 2480, -6150, 0, 0, 0, 0x0,  bhv1Up, 31),
	OBJECT_WITH_ACTS(0, 4819, 3060, -204, 0, 218, 0, 0x40000,  bhvCoinFormation, 31),
	OBJECT_WITH_ACTS(0, 18346, 3900, -3221, 0, 180, 0, 0x40000,  bhvCoinFormation, 31),
	...
	OBJECT_WITH_ACTS(120, 14797, 3662, -6081, 0, 0, 0, 0x0,  bhvRecoveryHeart, 31),
	OBJECT_WITH_ACTS(124, 6616, 1102, 9311, 0, 0, 0, 0x520000,  bhvMessagePanel, 31),
	OBJECT_WITH_ACTS(152, 19372, 5629, -3372, 0, 0, 0, 0x0,  bhvShrink_Platform_MOP, 31),
	OBJECT_WITH_ACTS(152, 19372, 5629, -3122, 0, 0, 0, 0x0,  bhvShrink_Platform_MOP, 31),
	OBJECT_WITH_ACTS(152, 19122, 5629, -3122, 0, 0, 0, 0x0,  bhvShrink_Platform_MOP, 31),
	OBJECT_WITH_ACTS(152, 19122, 5629, -3372, 0, 0, 0, 0x0,  bhvShrink_Platform_MOP, 31),
	OBJECT_WITH_ACTS(0, -4, 5, 40, 0, 0, 20, 147,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -5, 5, 231, 0, 0, 20, 148,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -4, 5, 102, 0, 0, 20, 149,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -5, 5, 335, 0, 0, 20, 150,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 80, 4, 135, 0, 0, 20, 151,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
