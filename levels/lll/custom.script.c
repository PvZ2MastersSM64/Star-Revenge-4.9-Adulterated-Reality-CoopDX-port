...
const LevelScript local_objects_lll_1_[] = {
	...
	OBJECT_WITH_ACTS(0, -4, 5, 70, 0, 0, 20, 162,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -4, 5, 246, 0, 0, 20, 163,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -4, 5, 10, 0, 0, 20, 164,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -4, 5, 26, 0, 0, 20, 165,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -5, 5, 14, 0, 0, 20, 166,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -4, 5, 33, 0, 0, 20, 167,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -4, 5, 4, 0, 0, 20, 168,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
