...
const LevelScript local_objects_pss_1_[] = {
	...
	OBJECT_WITH_ACTS(0, 4, 4, 52, 0, 0, 20, 363,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
...
const LevelScript local_objects_pss_2_[] = {
	...
	OBJECT_WITH_ACTS(0, 7, 4, 52, 0, 0, 20, 364,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
...
const LevelScript local_objects_pss_3_[] = {
	...
	OBJECT_WITH_ACTS(0, 4, 5, 152, 0, 0, 20, 365,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -12, 5, 140, 0, 0, 20, 366,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 4, 5, 4, 0, 0, 20, 367,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 4, 5, 4, 0, 0, 20, 368,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 4, 5, 4, 0, 0, 20, 369,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 4, 5, 4, 0, 0, 20, 370,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 4, 5, 4, 0, 0, 20, 371,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 4, 5, 4, 0, 0, 20, 372,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 4, 5, 4, 0, 0, 20, 373,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 4, 5, 4, 0, 0, 20, 374,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -12, 5, 78, 0, 0, 20, 375,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
...
const LevelScript local_objects_pss_5_[] = {
	...
	OBJECT_WITH_ACTS(0, -7, 4, 52, 0, 0, 20, 376,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
...
const LevelScript local_objects_pss_6_[] = {
	...
	OBJECT_WITH_ACTS(0, -7, 5, 110, 0, 0, 20, 377,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 7, 4, 52, 0, 0, 20, 378,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
