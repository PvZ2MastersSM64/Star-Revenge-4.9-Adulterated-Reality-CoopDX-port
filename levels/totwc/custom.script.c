...
const LevelScript local_objects_totwc_1_[] = {
	...
	OBJECT_WITH_ACTS(0, 3, 4, 702, 0, 0, 20, 270,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 3, 4, 1106, 0, 0, 20, 271,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 3, 4, 171, 0, 0, 20, 272,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 3, 4, 45, 0, 0, 20, 273,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
...
const LevelScript local_objects_totwc_2_[] = {
	...
	OBJECT_WITH_ACTS(0, -10, 5, 165, 0, 0, 20, 274,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 19, 4, 82, 0, 0, 20, 275,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
