...
const LevelScript local_objects_wdw_1_[] = {
	...
	OBJECT_WITH_ACTS(0, 10, 4, 179, 0, 0, 20, 191,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -15, 5, 69, 0, 0, 20, 192,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, 5, 4, 4, 0, 0, 20, 193,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
