...
const GeoLayout Geo_wf_1_0x154db80[]= {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_NODE_ORTHO(100),
			GEO_OPEN_NODE(),
				GEO_BACKGROUND(SkyboxCustom22183008_skybox_ptrlist, geo_skybox_main),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(1, DL_wf_1_0xe12dfe0),
					GEO_DISPLAY_LIST(4, DL_wf_1_0xe160238),
					GEO_DISPLAY_LIST(5, DL_wf_1_0xe1638f8),
					GEO_RENDER_OBJ(),
