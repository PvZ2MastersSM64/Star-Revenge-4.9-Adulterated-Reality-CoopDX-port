...
const LevelScript level_wmotr_entry[] = {
	...
	FREE_LEVEL_POOL(),
	MARIO_POS(/* area */ 1, /* yaw */ 0, /* pos */ -7516, 442, 1353),
...
const LevelScript local_objects_wmotr_2_[] = {
	...
	OBJECT_WITH_ACTS(0, -10, 5, 5, 0, 0, 20, 379,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -18, 5, 102, 0, 0, 20, 380,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -22, 5, 61, 0, 0, 20, 381,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -18, 5, 4, 0, 0, 20, 382,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -18, 5, 22, 0, 0, 20, 383,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -22, 5, 61, 0, 0, 20, 384,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -18, 5, 4, 0, 0, 20, 385,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -10, 5, 109, 0, 0, 20, 386,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -10, 5, 37, 0, 0, 20, 387,  RM_Scroll_Texture, 31), // EDITED
	OBJECT_WITH_ACTS(0, -10, 5, 72, 0, 0, 20, 388,  RM_Scroll_Texture, 31), // EDITED
	RETURN()
};
